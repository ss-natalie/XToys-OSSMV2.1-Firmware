...
const float hardcode_maxSpeedMmPerSecond = 1400.0f;
...
const float hardcode_maxStrokeLengthMm = 175.f;
/*
        Web Config
*/
...
const float xtoyAccelartion   = 80000.0f;         // Hard Coded Acceleration.
